...
var UserController = function () {
    var _classDecorators = [(0, inversify_express_utils_1.controller)("/users")];
    ...
    var UserController = _classThis = /** @class */ (function () {
        function UserController_1(userUseCase) {
            this.userUseCase = (__runInitializers(this, _instanceExtraInitializers), userUseCase);
        }
        UserController_1.prototype.getUsers = function (_, res) {
            return __awaiter(this, void 0, void 0, function () {
                var users;
                return __generator(this, function (_a) {
                    users = this.userUseCase.getUsers();
